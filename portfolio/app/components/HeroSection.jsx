    ...
    <section className="lg:py-16">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          Crafting scalable web solutions and building dynamic, user-friendly experiences with expertise in both frontend and backend technologies. From wireframes to production, I handle it all.
          </p>
          <div>
            <Link
              href="/#contact"
            ...
            <Link
              href="https://drive.google.com/file/d/1fGqs0DIUjV-bB7VFW58HW7glEWOl7sXE/view?usp=sharing" target="_blank"
